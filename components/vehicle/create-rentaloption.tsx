        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Duration of rental option (in minutes)</FormLabel>
                  <FormControl>
                    <Input placeholder="Please set duration in minutes..." {...field} disabled={isPending} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Price of rental</FormLabel>
                  <FormControl>
                    <Input placeholder="Please set price of rental..." {...field} disabled={isPending} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormItem>
                ...
                <FormControl className="w-40 bg-black text-white text-center rounded-mb border-solid p-2">
                  <select
                    {...field}
                    value={field.value ?? ''}
                    className="w-full bg-black text-white text-center rounded-md border-solid"
                    onChange={(event) => {
                  ...
                  >
                    ...
                    <option value="REGULAR">Regular rental</option>
